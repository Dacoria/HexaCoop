...
public static class AbilitySetup
{
    ...
    {
        new AbilitySetting{Type = AbilityType.Rocket,         Cost = 3,   AvailableFromTurn = 2,   EventImmediatelyFinished = false, Duration = 2.0f, IsPickup = false, AvailableFromQueuePlace = 1, TargetHexIsRelativeToPlayer = false},
        ...
        new AbilitySetting{Type = AbilityType.BombExplosion,  Cost = 3,   AvailableFromTurn = 1,   EventImmediatelyFinished = true,  Duration = 1.5f, IsPickup = false, AvailableFromQueuePlace = 0, TargetHexIsRelativeToPlayer = true},
